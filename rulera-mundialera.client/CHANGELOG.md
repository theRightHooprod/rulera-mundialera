...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest rulera-mundialera.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`rulera-mundialera.client.esproj`).
